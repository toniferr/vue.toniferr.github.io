<template>
  <div class="relative">
    ...
    >
      <img :src="`../assets/img/languages/flag_${$i18n.locale}.svg`" alt="flag" class="w-8 h-8">
      ...
      <ul v-on-clickaway="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute normal-case z-30 font-normal xs:left-0 lg:right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 lg:z-20">
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="../assets/img/languages/flag_en.svg" alt="english flag" class="h-8 w-8">
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="../assets/img/languages/flag_es.svg" alt="spanish flag" class="h-8 w-8">
